...
We will learn some more near the end of the course.
...
static methods:
- Comparator.naturalOrder(): returns a Comparator<T> that does the same thing as T's compareTo method.
    - that is, the Comparator's compare method returns positive wherever compareTo would return positive, etc.
- Comparator.reverseOrder(): returns a Comparator<T> that performs the opposite of T's compareTo method.
