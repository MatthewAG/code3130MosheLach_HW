...
- a toString method returning a String containing the textual representation
  of all components
- an equals method that compares the components of two objects of the record's type
- a hashCode method that returns an int derived from all the components.

The implicit constructor methods can be overridden, if desired.
